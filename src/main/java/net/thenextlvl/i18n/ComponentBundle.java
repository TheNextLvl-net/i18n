...
public sealed interface ComponentBundle permits ComponentBundleImpl {
     ...
     * @param translationKey the translation key representing the entry to be localized
     */
    void sendMessage(Audience audience, @NonNls String translationKey);
     ...
     */
    void sendMessage(Audience audience, @NonNls String translationKey, ComponentLike... arguments);
     ...
     */
    void sendMessage(Audience audience, @NonNls String translationKey, TagResolver... resolvers);
     ...
     * @param arguments      optional {@link ComponentLike} arguments used for replacing arguments in the translation
     */
    void sendActionBar(Audience audience, @NonNls String translationKey, ComponentLike... arguments);
     ...
     */
    void showTitle(Audience audience, @NonNls @Nullable String title, @NonNls @Nullable String subtitle, Title.@Nullable Times times, ComponentLike... arguments);
     ...
     * @see Audience#showTitle(Title)
     */
    void showTitle(Audience audience, @NonNls @Nullable String title, @NonNls @Nullable String subtitle, ComponentLike... arguments);
    ...
    sealed interface Builder permits ComponentBundleImpl.Builder {
         ...
         * migrations are performed before the {@link #scope(Scope) validation scope}.
         *
        ...
        /**
         * Sets the {@link Scope} for the builder.
         * <p>
         * Defaults to {@link Scope#FILTER_AND_FILL}.
         *
    ...
    /**
     * Enumeration representing the scope of validation.
     */
    enum Scope {
        /**
